...
public class JRelatorioUtils
{
	...
	public static File criarRelatorioXLSByQuerySQL(String query, String nomeRelatorio, String caminhoPersist)
	{
		RetornoRelatorioJDBC retorno = JUtils.buscaObjetosJDBCComCabecalhoUtilizandoPersist(query, caminhoPersist);
